    ...
    return (
      <div className="space-y-6 animate-fadeIn pb-12">
        <header>
          ...
          <h2 className="font-display text-2xl font-black tracking-tight text-bento-dark md:text-3xl flex items-center gap-2">
      ...
      <div className="bg-white p-4 rounded-xl border border-border-default shadow-sm space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border-default bg-bento-bg/40 py-2.5 pl-10 pr-4 text-xs text-bento-dark placeholder:text-[11px] sm:placeholder:text-xs outline-none transition focus:border-bento-green focus:bg-white"
          />
        </div>
